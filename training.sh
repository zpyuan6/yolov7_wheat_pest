...
python train.py --workers 6 --device 0 --batch-size 6 --data data\disease_dataset.yaml --img 512 512 --cfg cfg\training\yolov7_disease_detection.yaml --weights 'yolov7_training.pt' --name yolov7-disease-detection